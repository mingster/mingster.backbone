...
import { NotMountSkeleton } from "./not-mount-skeleton"
...
const ThemeToggler = () => {
    ...
    return (
        ...
        >
            ...
            />
            <span
                className={`-translate-y-1/2 absolute top-4 left-[3px] flex size-6 translate-x-0 items-center justify-center rounded-full shadow-switcher duration-75 ease-linear ${
